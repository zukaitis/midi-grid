...
public:
    ...
    void drawRectangle( const Coordinates& topLeft, const Coordinates& bottomRight, const Color& color ) override;
    void drawRectangle( const Coordinates& topLeft, uint16_t width, uint16_t height, const Color& color ) override;
